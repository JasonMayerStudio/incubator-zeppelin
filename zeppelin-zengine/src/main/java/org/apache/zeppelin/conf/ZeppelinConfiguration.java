...
public class ZeppelinConfiguration extends XMLConfiguration {
  ...
  public static enum ConfVars {
    ...
    ZEPPELIN_API_CONTEXT_PATH("zeppelin.api.context.path", "/api"),
    ZEPPELIN_SERVER_CONTEXT_PATH("zeppelin.server.context.path", "/"),
    ZEPPELIN_WEBAPP_CONTEXT_PATH("zeppelin.api.context.path", "/"),
    ZEPPELIN_WEBSOCKET_CONTEXT_PATH("zeppelin.api.context.path", "/ws"),
